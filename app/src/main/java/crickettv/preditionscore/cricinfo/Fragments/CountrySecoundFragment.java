...
public class CountrySecoundFragment extends androidx.fragment.app.Fragment {
    ...
    public CountrySecoundFragment(ArrayList<PlayerslistItem> secoundinningdata) {
        this.allplayeradata=secoundinningdata;
    }
