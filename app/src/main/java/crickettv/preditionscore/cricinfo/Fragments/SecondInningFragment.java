...
public class SecondInningFragment extends androidx.fragment.app.Fragment {
    ...
    public SecondInningFragment(ArrayList<MatchstItem> matchresultdatasecond) {
        this.matchresultdata = matchresultdatasecond;
    }
